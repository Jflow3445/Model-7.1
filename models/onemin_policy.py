...
# ──────────────────────────────────────────────────────────────────────────────
# Shared utils/blocks (mirrors onemin policy upgrades)
# ──────────────────────────────────────────────────────────────────────────────
...
class CrossAssetAttention(nn.Module):
    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        dtype_in = x.dtype
        B = x.size(0)
        max_rows = int(os.environ.get("ONEMIN_XATTN_MAX_ROWS", "4096"))
        outs = []
...
# ──────────────────────────────────────────────────────────────────────────────
#OneMin-term feature extractor (onemin)
# ──────────────────────────────────────────────────────────────────────────────
class OneMinFeatureExtractor(BaseFeaturesExtractor):
    ...
    def __init__(
        ...
        **_: Any,
        ...
        self.max_tokens_per_chunk = int(os.environ.get("ONEMIN_MAX_TOKENS", "120000"))
    ...
    def forward(self, obs: torch.Tensor) -> torch.Tensor:
        ...
        max_rows_cap = int(os.environ.get("ONEMIN_MAX_ROWS", "8192"))  # default higher to reduce overhead
...
# ──────────────────────────────────────────────────────────────────────────────
# Hybrid distribution (identical to One Min)
# ──────────────────────────────────────────────────────────────────────────────
